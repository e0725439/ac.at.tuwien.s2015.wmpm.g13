...
public class ConfirmationEmailBean implements Processor{
	...
	@Autowired
	public ConfirmationEmailBean(JavaMailSender mailSender, SimpleMailMessage confirmationMail) {
	...
	public void process(Exchange exchange) throws Exception {
				SimpleOrder order = exchange.getIn().getBody(
						SimpleOrder.class);
				...
				this.confirmationMail.setText("We have received an order with the ID "+order.getOrderId());
